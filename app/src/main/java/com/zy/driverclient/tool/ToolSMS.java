...
public class ToolSMS {
	...
	public static String appkey = "16f71df2dfd1c";
	public static String appSecrect = "8ac5741a576a92cfdad63aafd820963e";
	 ...
	 *            手机短信验证码
	 */
	public static void submitVerificationCode(String phone,
			String validateCode, IValidateSMSCode callback) {
	...
	private static class MySMSHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			if (result == SMSSDK.RESULT_COMPLETE) {
				...
				if (null != mIValidateSMSCode) {
					mIValidateSMSCode.onFailed(throwable);
				}
